	...
	<form class="center" action="/member/resign" method="post">
		<div class="container">
			...
			<div>
				...
				탈퇴 후에는 아이디 ${authInfo.id }로 재가입이 불가하며, 삭제된 데이터 역시 복구가 불가합니다.<br>
				작성한 게시글과 회원에 대한 모든 데이터는 삭제됩니다. 회원 탈퇴는 신청일로부터 7일 이내에 철회가 가능합니다.

				<div>
					<br> <br> <br> <label><input type="checkbox"
						name="resignchk" id="resignchk" value="true">안내 사항을 모두
