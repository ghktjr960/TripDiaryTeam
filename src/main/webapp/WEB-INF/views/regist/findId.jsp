	...
	function fn_emailChk() {
		$
				.ajax({
					...
					dataType : "text",
					data : {
						"email" : document.getElementById('emailchk').value
					},
					success : function(data) {
						...
						if (data != "none") {
							...
							$("#chkid").attr("value", "Y");
							document.getElementById('searchresult').innerHTML = "해당 이메일로 가입한 아이디는 "
									+ data + " 입니다.";
		...
		<div class="row">
			...
			<form method="post" class="col-lg-4 shadow mt-5 mb-5">
				...
				<div>
					<br>
					<div>
						이메일 <br> <input type="text" name="emailchk" id="emailchk"
							onchange="check_email();" class="form-control"
							style="width: 300px; margin: auto;">
						<div class="emailchked" id="emailchked">이메일을 입력하세요.</div>
					</div>
					<button type="button" name="chkid" id="chkid"
						class="btn btn-primary" onclick="fn_emailChk();" value="N">아이디
						찾기</button>
				</div>
				<div>
					<br>
			...
			<form method="post" class="col-lg-4 shadow mt-5 mb-5">
				...
				<div>
					...
					<div>
						아이디 <br> <input type="text" name="idchk" id="idchk"
							class="form-control" style="width: 300px; margin: auto;">
				...
				<button type="button" name="chkpw" id="chkpw"
					class="btn btn-primary" onclick="fn_pwChk();" value="N">비밀번호
					찾기</button>
				...
				<div class="pwsearchresult" id="pwsearchresult"
					name="pwsearchresult"></div>
