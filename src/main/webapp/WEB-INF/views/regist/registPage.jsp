		...
		<form action="/regist/registPage" method="post">
			...
			<div class="registPageForm shadow mb-5">
				...
				<div class="form-group">
					...
					<div class="idvalid" id="idvalid">아이디를 입력하세요. (영문 소문자, 숫자만 입력
						가능)</div>
				...
				<div class="form-group">
					...
					<input type="password" class="form-control" name="password"
						id="password" placeholder="암호 입력 " onchange="check_pw()">
					...
					<div class="form-group">
						...
						<div>
							...
							<button class="nickChk btn btn-secondary mb-3" type="button"
								id="nickChk" onclick="fn_nickChk();" value="N" disabled>닉네임
								중복확인</button>
