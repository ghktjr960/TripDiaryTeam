	...
	<div class="container">
		...
		<div class ="row">
			...
			<div class = "col-lg-4 mb-5 mt-5 shadow">
				...
				<p>
				<input type = button class="btn btn-primary" name = "info" id = "info" value ="회원 정보 수정" onclick = "fn_infoUpdate();">
				</p>
			</div>
			<div class = "col-lg-1 "></div>
			<div class = "col-lg-1 "></div>
			<div class = "col-lg-4 mb-5 mt-5 shadow">		
				...
				<input type = button class="btn btn-primary" name = "pwchange" id = "pwchange" value ="변경" onclick = "fn_pwUpdate();">
				
			</div>
			<div class = "col-lg-1 "></div>
		
		</div>
	<p class="mt-5">TripDiary를 이용하지 않는다면 <a href = "/member/resign">회원탈퇴 바로가기</a></p>
