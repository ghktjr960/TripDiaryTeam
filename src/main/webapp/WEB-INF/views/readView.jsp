...
<body>
   ...
   <div class="container">
      ...
      <div class="col-2">
         ...
         <form role="form" name="readForm" method="get" class="col-4 border border-secondary mt-5 mb-5">
               <div  style="float: left;" class="mt-3">
                  <img alt="" src="<spring:url value='/image/profile_64.png'/>"
         ...
         <div class="col-3" style="text-align: left">
            <div class="mt-5" >
               ...
               <br><div style="overflow:auto; height: 140px; padding-left: 3px;" class="border">게시글 내용 : ${read.content}</div><br>
               <br>
            </div>
